...
import com.dogecoin.dogecoinj.signers.StatelessTransactionSigner;
...
import com.dogecoin.dogecoinj.testing.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: dogecoinj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("dogecoinj-unit-test", null);
