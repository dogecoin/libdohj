...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link com.dogecoin.dogecoinj.crypto.MnemonicCode} for more
     ...
     *
     * @throws com.dogecoin.dogecoinj.crypto.MnemonicException if check fails
     */
