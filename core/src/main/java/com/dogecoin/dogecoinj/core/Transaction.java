...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.dogecoin.dogecoinj.script.Script, ECKey, com.dogecoin.dogecoinj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.dogecoin.dogecoinj.core.Transaction.SigHash, boolean)}
