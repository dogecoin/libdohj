...
import com.dogecoin.dogecoinj.net.discovery.TorDiscovery;
import com.dogecoin.dogecoinj.script.Script;
import com.dogecoin.dogecoinj.utils.DaemonThreadFactory;
import com.dogecoin.dogecoinj.utils.ExponentialBackoff;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     *         Use {@link com.dogecoin.dogecoinj.core.Peer#getConnectionOpenFuture()} if you
    ...
    /**
     * Use {@link com.dogecoin.dogecoinj.core.Context#getConfidenceTable()} instead, which can be retrieved via
     * {@link com.dogecoin.dogecoinj.core.AbstractBlockChain#getContext()}. Can return null if this peer group was
     ...
     * peers. By using this with {@link com.dogecoin.dogecoinj.core.PeerGroup#getMaxConnections()} you can wait until the
    ...
    /**
     * See {@link com.dogecoin.dogecoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.dogecoin.dogecoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.dogecoin.dogecoinj.core.Peer#ping()}.
     */
