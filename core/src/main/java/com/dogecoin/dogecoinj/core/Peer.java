 ...
 * {@link com.dogecoin.dogecoinj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.dogecoin.dogecoinj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link com.dogecoin.dogecoinj.net.NioClientManager#openConnection(java.net.SocketAddress, com.dogecoin.dogecoinj.net.StreamParser)}
     * or
     * {@link com.dogecoin.dogecoinj.net.NioClient#NioClient(java.net.SocketAddress, com.dogecoin.dogecoinj.net.StreamParser, int)}.</p>
     *
     ...
     * Once the pong is received the value returned by {@link com.dogecoin.dogecoinj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.dogecoin.dogecoinj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.dogecoin.dogecoinj.core.Peer#ping()} has never
