...
import com.dogecoin.dogecoinj.signers.MissingSigResolutionSigner;
import com.dogecoin.dogecoinj.signers.LocalTransactionSigner;
import com.dogecoin.dogecoinj.signers.TransactionSigner;
...
import com.dogecoin.dogecoinj.utils.BaseTaggableObject;
...
import com.dogecoin.dogecoinj.wallet.WalletTransaction.Pool;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.dogecoin.dogecoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
     ...
     * {@link com.dogecoin.dogecoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(com.dogecoin.dogecoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.dogecoin.dogecoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(com.dogecoin.dogecoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.dogecoin.dogecoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link com.dogecoin.dogecoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link com.dogecoin.dogecoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(com.dogecoin.dogecoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.dogecoin.dogecoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(com.dogecoin.dogecoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.dogecoin.dogecoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.dogecoin.dogecoinj.wallet.WalletFiles.Listener)}
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.dogecoin.dogecoinj.crypto.KeyCrypter,
     ...
     * of {@link com.dogecoin.dogecoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link com.dogecoin.dogecoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link com.dogecoin.dogecoinj.signers.TransactionSigner.MissingSignatureException}
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.dogecoin.dogecoinj.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * If not null, the {@link com.dogecoin.dogecoinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
...
//                            throw new IllegalArgumentException("Tried to send dust with ensureMinRequiredFee set - no way to complete this");
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.dogecoin.dogecoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * {@link com.dogecoin.dogecoinj.core.PeerFilterProvider} interface and generally should not be used directly by apps.
